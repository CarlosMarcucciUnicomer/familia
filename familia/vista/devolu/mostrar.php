...
?>
        ...
        <ol class="breadcrumb">
                    ...
                    <li><a href="mostrar.php">Devoluciones</a></li>
                    <li class="active">Mostrar</li>
                    </ol>
                   
            <div id="page-content" style="color:black">
                <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="color:black">Devoluciones</h3>
                        </div>
...
libro_prestamo ON libro_prestamo.idprest = prestamo.idprest INNER JOIN libro ON libro.idlibro = libro_prestamo.idlibro where prestamo.estado ='1' GROUP BY prestamo.idprest ORDER BY prestamo.idprest;");
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li class="active-sub">
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li class="active-link"><a href="mostrar.php">Devoluciones</a></li>
                                        </ul>
                                    </li>
