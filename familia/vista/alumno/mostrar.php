...
<?php
    ...
    $count = 0;
    $sql2 = "SELECT * FROM alumno WHERE estado = 0";
    $result = mysqli_query($conn, $sql2);
    $count = mysqli_num_rows($result);
?>
                       <!----------------------------------Notification dropdown------------------------------------------->
                       <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle" onclick="myFunction()">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a href="../vista/pages-logout.php"><i class="demo-pli-unlock icon-lg icon-fw"></i> Cerrar sesion</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <div id="page-content">
                <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="color:black">Alumnos</h3>
                        </div>
                         <button class="btn btn-purple" data-target="#demo-default-modal" data-toggle="modal"><i class="demo-pli-add icon-fw"></i>Nuevo</button>
                         <a href="../vista/alumno/reporte.php" title="Reporte" class="btn btn-default"><i class="demo-pli-printer icon-lg"></i> </a> 
                        <div class="panel-body">
                            <table id="myTable" cellspacing="0" width="100%">
                               ...
                               <tbody class="BusquedaRapida" style="color:black">
                                    ...
                                    ?>
                                            <tr style="color:black">
                                                <td><?php echo $va['idalum'];?></td>
                                                <td><?php  echo "<img src='../assets/img/subidas/".$va['foto']."'width='50'"; ?></td>
                                                <td><?php echo $va['dnia'];?></td> 
                                                <td><?php echo $va ['noma'];?>&nbsp;<?php echo $va ['apea'];?></td>
                                                <td><?php echo $va['correo'];?></td> 
                                                <td>
                                                    <?php    
                                                        if($va['estado']==1)  {
                                                    ?> 
                                                            <form  method="get" action="javascript:activo('<?php echo $va['idalum']; ?>')">
                                                                <button type="submit" class="btn btn-success btn-xs">Estudiando</button>
                                                            </form>
                                                    <?php  
                                                        }else{
                                                    ?> 
                                                        <form  method="get" action="javascript:inactivo('<?php echo $va['idalum']; ?>')"> 
                                                            <button type="submit" class="btn btn-danger btn-xs">No estudia</button>
                                                        </form>
                                                    <?php  
                                                        } 
                                                    ?>                         
                                                ...
                                                <td>
                                                    <a href="../vista/alumno/alum_per.php?id=<?php echo $va["idalum"]; ?>" title="Entrar"  class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
                                                    <a href="#edit_<?php echo $va["idalum"]; ?>" title="Editar datos"  class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                                    <a href="#delete_<?php echo $va["idalum"]; ?>" title="Eliminar"  class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
                                                    <?php include('../vista/alumno/modal.php'); ?>                    
                                                </td>
                    ...
                    <form method="POST"  autocomplete="off" enctype="multipart/form-data">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label">CUI de alumnos</label>
                                        <input type="text" name="dnia" maxlength="8" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="noma" required="" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apea" required="" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label">Direccion del alumno</label>
                                        <input type="text" name="direcc" required="" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                   <div class="form-group">
                                    ...
                                    <div class="radio">
                                        ...
                                        <input id="demo-disabled-inline-form-radio-2" name="gene" class="magic-radio" type="radio" value='M'>

                                        <label for="demo-disabled-inline-form-radio-2">M</label>
                    
                                        <input id="demo-disabled-inline-form-radio-3" name="gene" class="magic-radio" type="radio" value='F'>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fenaci" required="" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="nano-content">
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li class="active-sub">
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li class="active-link"><a href="alumno.php">Mostrar</a></li>
...
$sql = "select * from alumno where dnia='$dnia' or correo='$correo'";
...
$sql2 = "INSERT INTO alumno(dnia,noma,apea,edad,direcc,correo,gene,fenaci,foto,estado)VALUES ('$dnia','$noma','$apea','$edad','$direcc','$correo','$gene','$fenaci','$foto','$estado')";
$foto = $_FILES['foto'];
...
Swal.fire({
  ...
  timer: 1500
            ...
            window.location = "../folder/alumno.php";
        });
        </script>
...
<?php
    ...
    $id = $_GET['id'];
        ...
        $sql2 = "update alumno set dnia='$dnia', noma='$noma', apea='$apea', edad='$edad', direcc='$direcc', correo='$correo', gene='$gene',fenaci='$fenaci' where idalum='$id'";
...
?>
<!--------------------------------script editar termin----------------------------->

<script>
    function activo(idalum)
{
    var id=idalum;
    $.ajax({
        type:"GET",
        ...
        window.location.href ='../folder/alumno.php';
    })

}

// Editar estado inactivo
function inactivo(idalum)
{
    var id=idalum;
    $.ajax({
        type:"GET",
...
<script type="text/javascript">
      function myFunction() {
        $.ajax({
          url: "../vista/alumno/notificaciones.php",
          type: "POST",
          processData:false,
