...
?>
        ...
        <ol class="breadcrumb">
                    ...
                    <li><a href="../../folder/docente.php">Docente</a></li>
...
$con = connect();
$id = $_GET['id'];
$sql = "SELECT * FROM docente  WHERE iddoce= '$id'";
$query  =$con->query($sql);
$data =  array();
if($query){
...
<?php if(count($data)>0):?>
    <?php foreach($data as $d):?>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h4 style="color:black" class="text-lg text-overflow mar-no"><?php echo $d->nombre; ?><br><?php echo $d->apellido; ?></h4>
                                        ...
                                        <p style="color:black"><i class="demo-pli-address-book icon-lg icon-fw"></i> <?php echo $d->nombre; ?></p>

                                        <p style="color:black"><i class="demo-pli-address-book icon-lg icon-fw"></i> <?php echo $d->apellido; ?></p>

                                      
                                        <p style="color:black"><i class="demo-pli-mail icon-lg icon-fw"></i><?php echo $d->correo; ?></p>

                                        <p style="color:black"><i class="demo-pli-address-book icon-lg icon-fw"></i><?php echo $d->genero; ?></p>
                                    ...
                                    <div class="fluid">
                                        ...
                                        <div class="pad-btm">
                                            ...
                                            <div class="mar-top clearfix">
                                                <button class="btn btn-sm btn-primary pull-right" type="submit"><i class="demo-psi-right-4 icon-fw"></i> Enviar mensaje</button>
                            ...
                            <div class="nano-content">
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li class="active-sub">
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li class="active-link"><a href="../../folder/docente.php">Mostrar</a></li>
