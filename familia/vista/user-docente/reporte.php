...
$display_heading = array('idasisa'=>'#', 'noma'=> 'Nombre', 'apea'=> 'Apellidos','nomsec'=> 'Seccion','noms'=> 'Subgrado','nombre'=> 'Docente','fecha_create'=> 'Fecha', 'presen'=> 'Asistencia');
...
$header = mysqli_query($connString, "SHOW columns FROM asisten_alumn");
...
$w = array(15, 50, 50, 25,30,45,35,30);
//Declaramos el encabezado de la tabla
$pdf->Cell(15,12,'ID',1);
$pdf->Cell(50,12,'NOMBRE',1);
$pdf->Cell(50,12,'APELLIDOS',1);
$pdf->Cell(25,12,'SECCION',1);
$pdf->Cell(30,12,'SUBGRADO',1);

$pdf->Cell(45,12,'DOCENTE',1);
$pdf->Cell(35,12,'FECHA',1);
$pdf->Cell(30,12,'ASISTENCIA',1);
$pdf->Ln();
...
foreach(explode('__', $row['subgrado']) as $subgradoConcatenados){ 
       $subgrado = explode('..', $subgradoConcatenados);
   $pdf->Cell($w[4],6,utf8_decode($subgrado['1']),1);    
}


$pdf->Cell($w[5],6,utf8_decode($row['nombre']),1);
$pdf->Cell($w[6],6,$row['fecha_create'],1);
$pdf->Cell($w[7],6,utf8_decode($row['presen']),1);
