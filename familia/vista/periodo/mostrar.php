            ...
            <div id="page-content">
                <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="color:black">Periodo academico</h3>
                        </div>
                        ...
                        <div class="panel-body">
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr style="color:black">
            <td><?php echo $va['idper'];?></td>
                 
            <td><?php echo $va ['nompe'];?></td>
                             
            <td>
                
                <a href="#edit_<?php echo $va["idper"]; ?>" title="Editar datos"  class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                <a href="#delete_<?php echo $va["idper"]; ?>" title="Eliminar"  class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
                
                <?php include('../vista/periodo/modal.php'); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registro de periodos</h4>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nompe" required="" class="form-control">
                                                </div>
                                            </div>
                            ...
                            <div class="nano-content">
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li class="active-sub">
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li class="active-link"><a href="periodo.php">Mostrar</a></li>
...
$sql = "select * from periodo where nompe='$nompe'";
...
$sql2 = "insert into periodo (nompe) values ('$nompe')";
...
Swal.fire({
  ...
  timer: 1500
            ...
            window.location = "../folder/periodo.php";
        });
        </script>
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update periodo set nompe='$nompe' where idper='$id'";
