...
?>
        ...
        <ol class="breadcrumb">
            ...
            <div id="page-content">
                <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="color:black">Cursos</h3>
                        </div>
                         <button class="btn btn-purple" data-target="#demo-default-modal" data-toggle="modal"><i class="demo-pli-add icon-fw"></i>Nuevo</button>
                         <a href="../vista/curso/reporte.php" title="Reporte" class="btn btn-default"><i class="demo-pli-printer icon-lg"></i> </a> 
                        <div class="panel-body">
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr style="color:black">
            <td><?php echo $va['idcur'];?></td>
                 
            <td><?php echo $va ['nomcur'];?></td>
            
            <td><span class="label label-default"><?php echo $va ['nomgra'];?></span></td>
            <td><span class="label label-default"><?php echo $va ['noms'];?></span></td>
            ...
            <td><?php  echo "<img src='../assets/img/subidas/".$va['foto']."'width='50'"; ?></td>
             <td>
                <?php if($va ['estado']==1)  { ?> 
                <form  method="get" action="javascript:activo('<?php echo $va['idcur'];?>')">
                    <strong>
             ...
             <form  method="get" action="javascript:inactivo('<?php echo $va['idcur'];?>')"> 
        ...
        <?php  } ?>  
            ...
            <td>
                ...
                <a href="#edit_<?php echo $va["idcur"]; ?>" title="Editar datos"  class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                <a href="#delete_<?php echo $va["idcur"]; ?>" title="Eliminar"  class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>

               
                
                <?php include('../vista/curso/modal.php'); ?>
        ...
        <div class="modal-dialog">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomcur" required="" class="form-control">
                                    </div>
                                </div>
            ...
            <select class="demo_select2 form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="idper"  id="periodo" required="" title="Elige un año">
            ...
            <select class="demo_select2 form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="codgra"  id="grado" required="" title="Elige un grado">
             ...
             <option value="" disabled="" selected="">Selecciona el grado</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label">Subgrado</label>
            <select class="demo_select2 form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="codsub" id="sub" required="" title="Elige un subgrado">
...
$sql2 = "INSERT INTO curso(nomcur,idper,codgra,codsub,foto,estado)VALUES ('$nomcur','$idper','$codgra','$codsub','$foto','$estado')";
$foto = $_FILES['foto'];
...
Swal.fire({
  ...
  timer: 1500
            ...
            window.location = "../folder/curso.php";
        });
        </script>
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update curso set nomcur='$nomcur' where idcur='$id'";
