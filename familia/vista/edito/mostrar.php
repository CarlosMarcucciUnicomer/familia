            ...
            <div id="page-content">
                <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="color:black">Editorial</h3>
                        </div>
                         <button class="btn btn-purple" data-target="#demo-default-modal" data-toggle="modal"><i class="demo-pli-add icon-fw"></i>Nuevo</button>

                         <a href="../vista/edito/reporte.php" title="Reporte" class="btn btn-default"><i class="demo-pli-printer icon-lg"></i> </a> 
                        <div class="panel-body">
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr style="color:black">
            <td><?php echo $va['idedito'];?></td>
                 
            <td><?php echo $va ['nomedi'];?></td>
                             
            <td>
                
                <a href="#edit_<?php echo $va["idedito"]; ?>" title="Editar datos"  class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                <a href="#delete_<?php echo $va["idedito"]; ?>" title="Eliminar"  class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
                
                <?php include('../vista/edito/modal.php'); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registro de editoriales</h4>
                </div>
                                        ...
                                        <div class="row" style="margin-top:-30px">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Nombre de las editoriales</label>
                                                    <input type="text" name="nomedi" required="" class="form-control">
                                                </div>
                                            </div>
                            ...
                            <div class="nano-content">
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li class="active-sub">
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li class="active-link"><a href="edito.php">Editorial</a></li>
...
$sql = "select * from edito where nomedi='$nomedi'";
...
$sql2 = "insert into edito (nomedi) values ('$nomedi')";
...
Swal.fire({
  ...
  timer: 1500
            ...
            window.location = "../folder/edito.php";
        });
        </script>
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update edito set nomedi='$nomedi' where idedito='$id'";
