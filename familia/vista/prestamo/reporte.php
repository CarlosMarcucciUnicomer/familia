...
$this->Cell(80);
// Title
$this->Cell (95,10,utf8_decode('Lista de los prestamos'),1,0,'C');
...
$result = mysqli_query($connString, "SELECT libro_prestamo.idlibpre, libro.idlibro, libro.nomlibro, libro.aniopub, libro_prestamo.canti, prestamo.idprest, prestamo.fecha, prestamo.estado FROM libro_prestamo INNER JOIN libro ON libro_prestamo.idlibro = libro.idlibro INNER JOIN prestamo ON libro_prestamo.idprest =prestamo.idprest where prestamo.estado ='0'") or die("database error:". mysqli_error($connString));
