                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="mar-no text-nowrap text-main text-semibold">Clasificacion de comentarios</p>
...
?>
        ...
        <ol class="breadcrumb">
            ...
            <div id="page-content">
                <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="color:black">Autores</h3>
                        </div>
                         <button class="btn btn-purple" data-target="#demo-default-modal" data-toggle="modal"><i class="demo-pli-add icon-fw"></i>Nuevo</button>
                         <a href="../vista/autor/reporte.php" title="Reporte" class="btn btn-default"><i class="demo-pli-printer icon-lg"></i> </a>
            ...
            <td>
                ...
                <a href="#edit_<?php echo $va["idautor"]; ?>" title="Editar datos"  class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                <a href="#delete_<?php echo $va["idautor"]; ?>" title="Eliminar"  class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
                
                <?php include('../vista/autor/modal.php'); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registro de autores</h4>
                </div>
                                        ...
                                        <div class="row" style="margin-top:-30px">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Nombres de los autores</label>
                                                    <input type="text" name="datos" required="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                    <div class="form-group">
                 ...
                 <img id="blah" src="http://placehold.it/180" alt="your image" style="max-width:90px;" />
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="biog" placeholder="Biografia" rows="13" class="form-control"></textarea>
                                                </div>
                                            </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li class="active-sub">
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li class="active-link"><a href="autor.php">Autor</a></li>
...
$sql2 = "insert into autor (datos,biog,foto) values ('$datos','$biog','$foto')";
$foto = $_FILES['foto'];
...
Swal.fire({
  ...
  timer: 1500
            ...
            window.location = "../folder/autor.php";
        });
        </script>
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update autor set datos='$datos',biog='$biog' where idautor='$id'";
