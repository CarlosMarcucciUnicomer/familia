            ...
            <div id="page-content">
                <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="color:black">Libros</h3>
                        </div>
                         <button class="btn btn-purple" data-target="#demo-default-modal" data-toggle="modal"><i class="demo-pli-add icon-fw"></i>Nuevo</button>
                         <a href="../vista/libro/reporte.php" title="Reporte" class="btn btn-default"><i class="demo-pli-printer icon-lg"></i> </a>
                        <div class="panel-body">
                                ...
                                <thead>
                                    <tr style="color:black">
                                       ...
                                       <th class="min-tablet">Foto</th>
                                        <th class="min-tablet">Libro</th>
                                        <th class="min-tablet">Stock</th>
                                        <th class="min-tablet">Subgrado</th>
                                        <th class="min-tablet">Materia</th>
                                        <th class="min-tablet">Editorial</th>
                          ...
                          foreach ($dato as $key => $value){
                              foreach ($value as $va) { ?>
                           <tr style="color:black">
            <td><?php  echo "<img src='../assets/img/subidas/".$va['img']."'width='50'"; ?></td>
            <td><?php echo $va['idlibro'];?></td> 
            <td><?php echo $va['nomlibro'];?></td>
...
?>
            ...
            <td><?php echo $va ['nomcur'];?></td>
            <td><?php echo $va ['nomedi'];?></td>
            <td><?php echo $va ['datos'];?></td>
            <td>
                <?php    

                if($va['estado']==1)  { ?> 
                <form  method="get" action="javascript:activo('<?php echo $va['idlibro']; ?>')">
                    <button type="submit" class="btn btn-success btn-xs">Activo</button>
                </form>
                <?php  }   else {?> 

                    <form  method="get" action="javascript:inactivo('<?php echo $va['idlibro']; ?>')"> 
                        <button type="submit" class="btn btn-danger btn-xs">No activo</button>
                     </form>
                        <?php  } ?>                         
            </td>
            ...
            <td>
                ...
                <a href="#edit_<?php echo $va["idlibro"]; ?>" title="Editar datos"  class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                <a href="#delete_<?php echo $va["idlibro"]; ?>" title="Eliminar"  class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
                
                <?php include('../vista/libro/modal.php'); ?>
        ...
        <div class="modal-dialog">
            ...
            <select class="demo_select2 form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="idcur" id="curso" required="" title="Elige un curso">
            ...
            <select class="demo_select2 form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="idautor" id="autor" required="" title="Elige un grado">
            ...
            <select class="demo_select2 form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="idedito" id="edito" required="" title="Elige un grado">
             ...
             <option value="" disabled="" selected="">Selecciona la editorial</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label">Foto</label>
                                            <input type="file" id="imagen" name="img" onchange="readURL(this);" data-toggle="tooltip">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="pag" required="" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="aniopub" required="" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="demo_select2 form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="idio"  required="" title="Elige un grado">
             ...
             <option value="English">Ingles</option>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="precio" required="" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="stock" maxlength="3" required="" class="form-control">
                    </div>
                </div>
                 ...
                 <div class="col-sm-6">
                    <div class="form-group">
                        <label class="control-label">Sinopsis</label>
                         <textarea name="sinop" placeholder="Sinopsis" rows="5" class="form-control"></textarea>
                    </div>
                </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li class="active-sub">
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li class="active-link"><a href="libro.php">libros</a></li>
...
$sql = "select * from libro where nomlibro='$nomlibro'";
...
$sql2 = "insert into libro (nomlibro,codsub,idcur,idautor,idedito,img,sinop,pag,aniopub,precio,stock,estado,idio) 
values ('$nomlibro','$codsub','$idcur','$idautor','$idedito','$img','$sinop','$pag','$aniopub','$precio','$stock','$estado',
'$idio')";
$img = $_FILES['img'];
move_uploaded_file($img['tmp_name'], "../assets/img/subidas/".$img['name']);
...
Swal.fire({
  ...
  timer: 1500
            ...
            window.location = "../folder/libro.php";
        });
        </script>
...
Swal.fire({
 ...
 {
// Si no hay resultados, ingresamos el registro a la base de datos
$sql2 = "update libro set nomlibro='$nomlibro',idautor='$idautor',idedito='$idedito',sinop='$sinop',pag='$pag',aniopub='$aniopub',precio='$precio',stock='$stock',idio='$idio' where idlibro='$id'";
...
?>
<script src="../assets/js/funciones/periodo2.js"></script>
<script src="../assets/js/funciones/autor.js"></script>
<script src="../assets/js/funciones/edito.js"></script>
<script>
